// Simple seed script that can be run with node directly
...
async function main() {
  ...
  for (const item of menuItems) {
    try {
      ...
      console.log(`⚠️  Menu item ${item.name_en} might already exist`);
    }
  }
  ...
  for (const code of discountCodes) {
    try {
      ...
      console.log(`⚠️  Discount code ${code.code} might already exist`);
    }
  }
  console.log(`✅ Created ${discountCount} discount codes`);
